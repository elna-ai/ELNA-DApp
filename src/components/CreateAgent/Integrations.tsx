          ...
          <div className="d-flex align-items-center">
            ...
            <div className="flex-grow-1 ms-3">
              ...
              <p className="text-desc fs-8">
                SoCal is AI-powered ally in navigating the world of social media
              </p>
            </div>
          </div>
          <hr className="mt-2" />
        ...
        <div className="col-md-8 app-integrated-sec">
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center">
              ...
              <div className="int-app-name ms-2">
                <p className="mb-0">Trading Bots</p>
              </div>
            </div>
            <div className="d-flex align-items-center">
              <div className="int-button">
        ...
        <div className="col-md-8 app-integrated-sec">
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center">
              ...
              <div className="int-app-name ms-2">
                <p className="mb-0">IoT Devices</p>
              </div>
            </div>
            <div className="d-flex align-items-center">
              <div className="int-button">
