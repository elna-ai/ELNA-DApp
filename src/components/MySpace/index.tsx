    ...
    <>
        ...
        <div className="myspace__tab">
          {MY_SPACE_LINK.map((link: MySpaceMenuProps) => (
            <OverlayTrigger
              ...
              placement="right-end"
              overlay={
                <Tooltip className="tooltip-menu">{link.toolTip}</Tooltip>
              }
            >
              <Link className="myspace__tab__navlink" to={link.to}>
      ...
      <Routes>
        <Route path="/" element={<Profile />}>
          <Route path="/my-agents" element={<Profile />} />
          <Route path="/my-tools" element={<Profile />} />
          <Route path="/plans" element={<Profile />} />
